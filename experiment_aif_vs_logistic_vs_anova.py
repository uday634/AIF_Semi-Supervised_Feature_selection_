...
def run_dataset_once(path: str, seed: int):
    ...
    aif_log = AdaptiveIsolationForestWithLogisticFS(schema, window_size=256, n_trees=50, seed=seed, label_budget=0.05)
    aif_anova = AdaptiveIsolationForestWithAnovaFS(schema, window_size=256, n_trees=50, seed=seed, label_budget=0.05)
